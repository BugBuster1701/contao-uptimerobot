...
';
    ...
    <td class="tl_file_list"><div class="radial-progress-type-2" data-progress="'.$arrMonitorStatus['alltimeuptimeratio'].'%"></div></td>
  </tr>
'; //'.$arrMonitorStatus['alltimeuptimeratio'].'
        		$lineCount++;
        	}
        	else 
        	{
...
';
            ...
            $table .= '</table>
';
            //RadialProgressBar ohne Animation
            //funktioniert mit Mootools 1.4 aber nicht 1.5 :-(
            $radialbar = "
<script>
	window.addEvent('domready', function () {
		$$('.radial-progress-type-2').each(function (el) {
			new RadialProgressBar(el, {
                borderColor: '#4db5e4',
				borderWidth: 6,
				elementSize: '60px',
				overlayColor: '#333',
